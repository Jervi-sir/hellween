...
(function ($) {
	...
	function updateColumnsAndContent() {
		...
		if (winWidth < 992) {
			...
			if ($(".footer-top .toggle-open").length == 0) {
				...
				$('.footer-top .newsletter-form').hide();
			}
		} else {
			...
			$('.footer-top .newsletter-form').show();
		}
	}
	...
	$(document).ready(function() {
		$('.latest, .html2').wrapAll("<div class='latest-html2 mt-100'><div class='container'><div class='row'></div></div></div>");
		// Slider
		setProductCarousel();
		// breadcrumb
		addbredcumb();
	    ...
	    setTimeout(function () {
			const { width: winWidth } = getViewport()
				if (prevWidth != winWidth) {
					...
					$('.footer-top-bottom .footer-content').insertAfter('.position-footer-left');
				}
				else{
					$('#menu').appendTo('.header-center');
					$('.footer-left').insertBefore('.footer-center');
					$('.footer-left .footer-content').appendTo('.footer-top-bottom');
				}			
				prevWidth = winWidth;
			}
	    }, 100);
	...
	$(document).ready(function() {
		if($(window).width() > 991) {
			...
			var image_index = 0;
			$(document).on('click', '.post-inner .inner1', function () {
				$('.gallery-post ').magnificPopup('open', image_index);
				return false;
			});
			...
			$('#additional-carousel a').click(function() {
				...
				$('.gallery .inner1').attr('href', largeImage);
				ez.swaptheimage(smallImage, largeImage);
				image_index = $(this).index('#additional-carousel a');
				return false;
			});
		} else {
			$(document).on('click', '.gallery .inner1', function () {
				$('.gallery-post').magnificPopup('open', 0);
				return false;
			});
		}
	});
